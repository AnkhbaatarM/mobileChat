...
import { Platform, Image, Text, TouchableOpacity, View, FlatList } from 'react-native';
...
export default class Index extends Component<Props, State> {
    ...
    componentDidMount() {
        ...
        if (params.startType === 'create') {
            ...
            this.init(params.appId, params.videoType);
        }
                ...
                RNFetchBlob.config({
                    ...
                    .then(responseJson => {
                        ...
                        sendSocket(roomId, {
                            ...
                            msg_type: 4,
                            isGroup: this.state.roomUsers.length > 2 ? true : false,
                            files: null,
                            date: new Date(),
                        });
                        this.setState({
                        ...
                        this.init(responseJson.appId, videoType);
                    });
            });
    };
     ...
     */
    init = async (appId: string, videoType) => {
            ...
            <View style={styles.fullView}>
                {peerIds.length > 0 && (
                    <FlatList
                        ...
                        data={peerIds}
                        renderItem={this.rowRenderer}></FlatList>
                )}
